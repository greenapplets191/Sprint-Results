                    ...
                    alertDialogBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        * */
                              ...
                              if(password.equals(taskList.get(position).getPassword())){
                                   taskList.remove(position);//tatangggalin ba siya o ireretain sa nakikita?di ko pinalitan since di ko sure.The only thing i know is ireretain siya sa DAO
                                   dao.taskList.get(position).completed=true;
                                   dao.writeToFile();
                                   notifyDataSetChanged();
